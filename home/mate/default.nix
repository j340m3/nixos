...
in {
  config = {
    ...
    home-manager.users.jeromeb = { pkgs, ...}: {
      ...
      dconf.settings = {
        "org/gnome/shell".favorite-apps = ["seclists.desktop" "payloadsallthethings.desktop" "powershell.desktop" "shell.desktop" "codium.desktop" "firefox.desktop" "cyberchef.desktop" "fuzzdb.desktop" "securitywordlist.desktop" "autowordlists.desktop" ];
